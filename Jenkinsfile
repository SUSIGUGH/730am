...
sh 'ssh -i jmtksrv01.pem -o StrictHostKeyChecking=no ec2-user@15.206.94.237 "cd /home/ec2-user && kubectl delete pod susi mysql -n dev && kubectl create -f mysql.yaml && kubectl get pods -n dev"'
